...
import { EbookModel } from './module/ebook/ebook.model'
...
const ebooks = [
  {
    ...
    description:
      'আগুনের বেসিক নলেজ বইটি আগুনের প্রাথমিক ধারণা, আগুন লাগার কারণ, এবং আগুন নিয়ন্ত্রণের সহজ উপায় নিয়ে লেখা হয়েছে।',
    outcomes: [
  ...
  },
  {
    ...
    description:
      'কর্মক্ষেত্রে দুর্ঘটনা বা জরুরি পরিস্থিতিতে কীভাবে দ্রুত ও নিরাপদভাবে প্রাথমিক চিকিৎসা দিতে হবে—এই বইটি ধাপে ধাপে সহজভাবে শেখাবে।',
    outcomes: [
  ...
  },
  {
    ...
    description:
      'দল পরিচালনা, দায়িত্ব বণ্টন, দৈনন্দিন কাজের শৃঙ্খলা এবং ভুল কমিয়ে নিরাপদ অপারেশন নিশ্চিত করতে—এই বইটি একটি বাস্তবভিত্তিক গাইড।',
    outcomes: [
  ...
  },
  {
    ...
    description:
      'ফ্যাক্টরি/আরএমজি পরিবেশে ফায়ার রিস্ক কন্ট্রোল, ইভাকুয়েশন ড্রিল, ইন্সপেকশন চেকলিস্ট এবং কমপ্লায়েন্স প্রস্তুতি—সবকিছু একত্রে সাজানো একটি প্রফেশনাল গাইড।',
    outcomes: [
...
async function seed() {
  try {
    ...
    // Insert seed data
    const result = await EbookModel.insertMany(ebooks)
